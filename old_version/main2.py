    ...
    for i in df["NAME"]:
        ...
        if str(i) == "nan":
            ...
            try:
                ...
                print("the photo of face in csv list is not available in face folder")
...
def yagmail():
    exists = os.path.isfile("Attendance\Attendance_" + date + ".csv")
    try:
        yag = yagmail.SMTP(user="hrtmine@gmail,com"
                           , password="fwee")
        yag.send(to=' sourav@gachon.ac.kr', subject='Sending Attachment', contents='Please find the image attached',
                 attachments='')
...
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="black", bg="#F5FD03",
...
trackImg = tk.Button(frame1, text="Send Email", command=yagmail, fg="black", bg="#1AFD03", width=35, height=1,
                     activebackground="white", font=('times', 15, ' bold '))
trackImg.place(x=90, y=105)
